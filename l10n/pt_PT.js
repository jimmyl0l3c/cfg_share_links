OC.L10N.register(
    ...
    "App adding the ability to specify share tokens" : "Aplicação que adiciona a capacidade de especificar tokens de partilha",
    "None" : "Nenhum",
    ...
    "Error occurred while saving settings" : "Ocorreu um erro ao guardar as definições",
    ...
    "Keep this option off if you did not use versions lower than 1.2.0" : "Mantenha esta opção desativada se não usou versões anteriores a 1.2.0",
    "Delete shares of deleted files during token checks (when creating/updating share)" : "Eliminar as partilhas dos ficheiros apagados durante as verificações dos tokens (ao criar/atualizar a partilha)",
    "Link copied" : "Hiperligação copiada",
    "Create link" : "Criar hiperligação",
    "Password protection enforced" : "Imposta proteção por palavra-passe",
