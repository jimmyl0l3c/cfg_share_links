OC.L10N.register(
    ...
    "Public link sharing is disabled by the administrator" : "公共連結分享已被管理員停用",
    ...
    "Link copied" : "已複製連結",
    "Create link" : "創建連結",
    "Password protection enforced" : "已實施密碼防護",
    "Enter password (optional)" : "輸入密碼（非強制的）",
    "Invalid token" : "無效的權杖",
